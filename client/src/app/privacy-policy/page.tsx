            ...
            <div className={`container ${styles.policyContainer}`}>
                ...
                <section className={styles.section}>
                    ...
                    <div className={styles.content}>
                        <p>Jaitun Oil ("we", "us", "our") respects your privacy and is committed to protecting the personal information you share with us. This policy describes how we collect, use, and share your information.</p>
                    </div>
                </section>
